      ...
      <section className="px-6 py-20">
        ...
        <div className="mx-auto max-w-2xl text-center space-y-8">
          ...
          <p className="text-base text-muted-foreground leading-relaxed">
            Мы создали уютный чат, где будем собирать все ваши снимки и видео — самые искренние улыбки, тёплые объятия и яркие кадры этого дня. Присоединяйтесь, чтобы вместе сохранить волшебство нашей свадьбы.
          </p>
          <a
